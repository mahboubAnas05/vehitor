<nav class="fixed-top bg-white">
    <div class="d-flex justify-content-between align-items-center border-bottom">
        ...
        <div class="d-md-flex d-none align-items-center gap-3 me-1">
            ...
            <div><a href="{{route('loginAgence')}}" class="btn btn-dark">Entrer Comme Agence</a></div>
    ...
    <div class="d-md-none border-bottom menu">
        <center>
            ...
            <div class="p-3"><a href="{{route('loginAgence')}}" class="w-100 btn btn-dark">Entrer Comme Agence</a></div>
